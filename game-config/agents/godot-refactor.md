...
2. Follow the preloaded `godot-verify` skill. Run `tools/validate.sh` BEFORE touching anything — if the baseline is not clean, stop and report; never refactor on top of breakage.
